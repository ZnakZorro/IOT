...
void olejOLED(){
    ...
    String d2 = doc["d2"];
    String d3 = doc["d3"];
    String s1 = doc["s1"]; if(s1=="null") {s1="@";}
    String s2 = doc["s2"];
    String s3 = doc["s3"];
    */
    //Serial.print(t1); Serial.print("; ");    Serial.print(t2); Serial.print("; ");    Serial.print(d1); Serial.print("; ");    Serial.print(d2); Serial.print("; ");     Serial.print(s1); Serial.print("; ");    Serial.print(s2); Serial.print("; "); 
        ...
        do {
            if (moda==0) {              
               String symbolIcon = doc["s1"];  if(symbolIcon=="null") {symbolIcon="D";};
               String t  = doc["t1"];  if(t=="null") {t="?";}
               String d  = doc["d1"];  if(d=="null") {d="?";}
               txt="t"+t+" d"+d;
               //txt="t"+doc["t1"]+" d"+doc["d1"];
               //txt="t";//+doc["t1"]+" d"+doc["d1"];
               //txt.concat(String doc["t1"]);
               linijka="_   ";
            }           
            if (moda==1) {
               String symbolIcon = doc["s2"];  if(symbolIcon=="null") {symbolIcon="D";};
            ...
            if (moda==2) {
               String symbolIcon = doc["s3"];  if(symbolIcon=="null") {symbolIcon="D";};
            ...
            if (txtLong>5) {u8g2.setFont(u8g2_font_profont22_mr);} // 10,11,12,15,17,22,29 // _mf=pelny _tr=skrocony _mn=numery
