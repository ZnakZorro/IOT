//#!/home/zbyszek/.nvm/versions/node/v15.8.0/bin/node


let debug = true;
const path = require('path');

//const express  = require("../Dokumenty/nodejs/node_modules/express");
const express  = require("/home/zbyszek/Dokumenty/nodejs/node_modules/express");
...
app.get("/copy/*", function(req, res){
	...
	/*
	copy200(nameIN,nameOUT,(e)=>{
		console.log(1,nameIN);
		console.log(2,nameOUT);
		console.log(3,e);
			console.log(4,nameIN,"\nFile contents copied to:",nameOUT); 
			console.log(5,"Send to radio");
			//res.send({"file":nameOUT});
			setTimeout(function(){console.log("Send to radio");res.send({"file":nameOUT});},155)			
	});
	*/	
...
server.listen(port,()=>{console.log("IP=",myIP+":"+port+"\nlocalhost:"+port+"\n");});
...
const getPlayList=()=>{
	...
	.then(o => {
		...
		o.forEach((mm)=>{
			...
			if (n.indexOf("00.")===0) n=n+"<span> rePlay</span>";
...
const graj=(ten)=>{
	...
	console.log(muza);
	if (muza.indexOf("00.")===0) {
		console.log("rePlay 00");
		fetch(radioURL+"radio?u="+localhost+muza);
		return;
	}
	$("#teraz").innerHTML = '<b>'+muza+'</b>';
